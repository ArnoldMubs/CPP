...
int main(int argc, char ** argv) {
    ...
    // TODO
    //VectorXd f = data.jacobiSvd(ComputeThinU | ComputeThinV).solve(dataY);
    ...
    double minY = dataY.minCoeff();
    double maxY = dataY.maxCoeff();
    VectorXd fitY = VectorXd::LinSpaced(DIVS, minY, maxY);
    // TODO
    std::cout << "\nf:\n"
	      << fitY << std::endl;
    return 0;
